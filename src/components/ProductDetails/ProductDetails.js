            ...
            <div className="row mx-md-n5">
              <div className="col-md-6">
                <div className="row">
                  ...
                  <div className="d-xs-flex d-xs-row col-md-2 mt-6-custom">
              ...
              <div className="col-md-6">
                ...
                <div className="product__color--quantity">
                  <div className="d-flex">
                    ...
                    <div className="mt-3 ml-4 quantity">Quantity</div>
                ...
                <div className="shipping">
                  <div className="d-flex flex-wrap justify-content-around">
                    ...
                    <div className="pickup-service m4">
                      <div className="service-img">
                    ...
                    <div className="product-request m4">
                      <div className="service-img">
              ...
              <div class="tab-content border" id="myTabContent">
                ...
                >
                  <p className="mt-4 mb-4">
                    ...
                    6.1-inch corning gorilla glass screen. It enables you to
                    view more and get immersive experience. Fun never stop: A
                    long-lasting battery keeps you enjoying every moment with
                    your phone, playing game, listening to music or watching
                    movies. Fingerprint unlock: Unlock in a moment, wake up the
                    phone with just a touch in any occasion.
                  </p>
                  <h6 className="mb-3">Mighty Performance</h6>
                  <p className="mt-4 mb-4">
                    Powered by the Qualcomm Snapdragon 712 AIE processor and 4
                    GB of RAM, this phone can handle any task seamlessly. The
                    ...
                    that you can store loads of pictures, videos and other
                    files.
                  </p>
                  <h6 className="mb-3">
                  ...
                  <p>
                    Housing a 5000-mAh battery, this phone has enough juice to
                    let you complete multiple tasks in one sitting. And, it is
                    just 8.85 mm thick. The 18 W Fast Charger powers up your
                    phone in no time. Also, it supports the OTG reverse charging
                    function, making charging hassle-free.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="feedback mb-3">
              <div className="d-flex flex-wrap">
                ...
                <p>
                  ...
                  says 10 day replacement. But after delivery the return option
                  is withdrawn from details of order and says if any problem
                  arises contact local Apple service centre. It is a clear fraud
                  for the customers who buy such a high priced handset. Customer
                  be careful about that. My set is running fine but it is not my
        ...
        <section className="questions">
          <div>
            <center>
              ...
              <a href="#">
                <img src={Whatsapp} className="wa" alt="" />
              </a>
            </center>
          </div>
          <br /> <br /> <br /> <br />
